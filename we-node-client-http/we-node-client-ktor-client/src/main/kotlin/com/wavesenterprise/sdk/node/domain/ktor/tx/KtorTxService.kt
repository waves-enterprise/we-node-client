...
import com.wavesenterprise.sdk.node.domain.coroutines.tx.TxService
...
import com.wavesenterprise.sdk.node.domain.http.tx.AtomicTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.AtomicTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.BurnTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.BurnTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.CallContractTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.CallContractTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.CreateAliasTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.CreateAliasTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.CreateContractTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.CreateContractTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.CreatePolicyTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.CreatePolicyTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.DataTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.DataTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.DisableContractTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.DisableContractTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.ExecutedContractTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.ExecutedContractTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.GenesisPermitTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.GenesisPermitTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.GenesisRegisterNodeTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.GenesisRegisterNodeTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.GenesisTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.GenesisTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.IssueTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.IssueTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.LeaseCancelTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.LeaseCancelTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.LeaseTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.LeaseTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.MassTransferTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.MassTransferTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.PermitTxDto.Companion.toDomain
...
import com.wavesenterprise.sdk.node.domain.http.tx.RegisterNodeTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.RegisterNodeTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.ReissueTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.ReissueTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.SetAssetScriptTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.SetAssetScriptTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.SetScriptTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.SetScriptTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.SponsorFeeTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.SponsorFeeTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.TransferTxDto.Companion.toDomain
...
import com.wavesenterprise.sdk.node.domain.http.tx.UpdateContractTxDto.Companion.toDomain
import com.wavesenterprise.sdk.node.domain.http.tx.UpdateContractTxDto.Companion.toDto
import com.wavesenterprise.sdk.node.domain.http.tx.UpdatePolicyTxDto.Companion.toDomain
